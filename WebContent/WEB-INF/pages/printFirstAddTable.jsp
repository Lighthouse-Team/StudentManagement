...
<script type="text/javascript">
	...
	$(function() {   
		...
		for( var i=0; i<4; i++){
  		...
  		firstGradeClassTitle.innerHTML= "附表1&nbsp;&nbsp;" + gradeList[0] + "级各班级优秀率、不及格率情况";       
  		var secondGradeClassTitle=document.getElementById("secondGradeRPECClass");  // 大三
  		secondGradeClassTitle.innerHTML="附表2&nbsp;&nbsp;" + gradeList[1] + "级各班级优秀率、不及格率情况";    
  		var thirdGradeClassTitle=document.getElementById("thirdGradeRPECClass");  // 大二
  		thirdGradeClassTitle.innerHTML= "附表3&nbsp;&nbsp;" + gradeList[2] + "级各班级优秀率、不及格率情况";     
  		var forthGradeClassTitle=document.getElementById("forthGradeRPECClass");  // 大一
  		forthGradeClassTitle.innerHTML= "附表4&nbsp;&nbsp;" + gradeList[3] + "级各班级优秀率、不及格率情况";        
