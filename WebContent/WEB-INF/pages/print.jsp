...
<script type="text/javascript">
	...
	for (var i = 0; i < odList.length; i++) {
			...
			var aRateNumber = parseFloat(odList[i].excellentRate.substring(0,
					odList[i].excellentRate.length - 1));
			var bRateNumber = parseFloat(odList[i].goodRate.substring(0,
					odList[i].goodRate.length - 1));
			var cRateNumber = parseFloat(odList[i].mediumRate.substring(0,
					odList[i].mediumRate.length - 1));
			var dRateNumber = parseFloat(odList[i].passRate.substring(0,
					odList[i].passRate.length - 1));
			var eRateNumber = parseFloat(odList[i].failRate.substring(0,
					odList[i].failRate.length - 1));
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<div id="scNumberPic"
							style="display: block; height: 400%; width: 95%; margin: 0; float: left">
						</div>
						<div id="scRatePic"
							style="display: block; height: 400%; width: 95%; margin: 0; float: left">
						</div>
