...
<script type="text/javascript">
	...
	$(function() {       
		...
		var yearSelectedNumber = parseInt(yearSelected.substring(0,4));
		var termSelected =document.getElementById("term").value;
		var termSelectedNumber = parseInt(termSelected);
		var gradeSelected =document.getElementById("grade").value;
		var gradeSelectedNumber = parseInt(gradeSelected);
		var grades = new Array();
		for(var i=0; i<2; i++) {
			grades.push(yearSelectedNumber - i);
		} 
	...
	/* 根据不同学年、学期和年级显示不同的课程名称 */
	function setCourseSelect(){
		var yearSelected =document.getElementById("year").value;
		var yearSelectedNumber = parseInt(yearSelected.substring(0,4));
		var termSelected =document.getElementById("term").value;
		var termSelectedNumber = parseInt(termSelected);
		...
		if(yearSelectedNumber == gradeSelected && termSelected == 1){
		...
		else if(yearSelectedNumber - 1 == gradeSelected && termSelected == 1){
			...
			<div class="container-fluid">
				...
				<div class="card card-default">
					...
					<div class="card-body">
						...
						<!-- /.row -->
						<input  type="submit" class="btn btn-info float-left" value="查询"   onclick = "ssj()"/> 
						</form>
