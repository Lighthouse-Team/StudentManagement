	...
	function getBarPic(){
		...
		$.post(url, args, function(bcodList){
			for(var i = 0; i < bcodList.length ; i++){
				option.xAxis[0].data[i] = bcodList[i].courseName;
			...
			var dom = document.getElementById("basicCourseOverallDistributionListBarPic");
		...
		<div class="content-wrapper">
				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">主要基础课程成绩情况统计</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid">
				...
				<div class="card card-default">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<form action="getBasicCourseOverallDistributionList" method="post">
						<div class="row">
							<div class="col-md-6">
				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body" style="margin: 0">
							...
							<button  class="btn btn-info float-left" onclick = "getBasicCourseOverallDistributionListData()">显示成绩分析图</button>
						</div>
						<!-- /.card-body -->
					</div>
					<!-- /.card -->
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<div id="basicCourseOverallDistributionListBarPic"  style="display:none; height: 400%; width:95%; margin: 0;float:left">
						</div>
					</div>
				</div>
			</div>
